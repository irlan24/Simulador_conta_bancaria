...
public class JCadastrarCliente extends JFrame {
    ...
    */
    ...
    public JCadastrarCliente() {
        ...
        panelCard.setBounds(40, 110, 420, 280); // 240
        ...
        lblCpfCliente.setFont(new Font("Segoe UI", Font.BOLD, 14));
        lblCpfCliente.setForeground(COR_TEXTO);
        lblCpfCliente.setBounds(30, 95, 150, 25);
        panelCard.add(lblCpfCliente);
        
        // Campo CPF Cliente
        txtCpfCliente = criarCampoTexto();
        txtCpfCliente.setBounds(30, 125, 360, 35);
        panelCard.add(txtCpfCliente);
        ...
        lblTipoConta.setBounds(30, 160, 150, 25);
        panelCard.add(lblTipoConta);
        
        // Campo Tipo Conta
        cmbTipoConta = criarComboBox();
        cmbTipoConta.setBounds(30, 190, 360, 35);
        ...
        btnCadastrar.setBounds(30, 235, 170, 40);
        ...
        btnCancelar.setBounds(220, 235, 170, 40);
    ...
    public void telaPrincipal(ContaBanco conta){
        ...
        // centralizar a tela e tornar visível
